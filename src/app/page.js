...
export default function Home() {
  return (<div className="handheld-toolbar-enabled">
...
<main className="page-wrapper">
  ...
  <header className="navbar d-block navbar-sticky navbar-expand-lg navbar-light bg-light">
    <div className="container"><a className="navbar-brand d-none d-sm-block me-4 order-lg-1" href="index.html"><img src="img/logo-dark.png" width={142} alt="Cartzilla" /></a><a className="navbar-brand d-sm-none me-2 order-lg-1" href="index.html"><img src="img/logo-icon.png" width={74} alt="Cartzilla" /></a>
      <div className="navbar-toolbar d-flex align-items-center order-lg-3">
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"><span className="navbar-toggler-icon" /></button><a className="navbar-tool d-none d-lg-flex" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#searchBox" role="button" aria-expanded="false" aria-controls="searchBox"><span className="navbar-tool-tooltip">Search</span>
          <div className="navbar-tool-icon-box"><i className="navbar-tool-icon ci-search" /></div></a><a className="navbar-tool ms-2" href="#signin-modal" data-bs-toggle="modal"><span className="navbar-tool-tooltip">Account</span>
          <div className="navbar-tool-icon-box"><i className="navbar-tool-icon ci-user" /></div></a>
      </div>
      <div className="collapse navbar-collapse me-auto order-lg-2" id="navbarCollapse">
        ...
        <ul className="navbar-nav navbar-mega-nav ms-lg-4 pe-lg-2 me-lg-2">
          <li className="nav-item dropdown"><a className="nav-link dropdown-toggle ps-lg-0" href="#" data-bs-toggle="dropdown"><i className="ci-location me-2" />New York</a>
  ...
  <section className="container pb-4 pt-2 pt-sm-0 pt-md-2 pb-sm-5">
    ...
    <div className="row pb-2 pb-sm-0 pb-md-3">
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/01.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/02.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/03.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/04.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/05.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/06.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/07.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/08.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/09.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/10.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/11.png" style={{width: 150}} alt="Brand" /></a></div>
      <div className="col-md-3 col-sm-4 col-6"><a className="d-block bg-white shadow-sm rounded-3 py-3 py-sm-4 mb-grid-gutter" href="food-delivery-single.html"><img className="d-block mx-auto" src="img/food-delivery/restaurants/logos/12.png" style={{width: 150}} alt="Brand" /></a></div>
    </div>
  </section>
  {/* Reviews*/}
